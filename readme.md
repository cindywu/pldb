# WhateverDB: a database for whatever

WhateverDB is a public domain database and website containing facts about whatever.

This repo contains the entire database, code, and website for https://whateverdb.com.
